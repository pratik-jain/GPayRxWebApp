...
namespace GooglePayRxWebApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(GooglePayRxWebApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(GooglePayRxWebApp.Models.Main.LanguageContent.ComponentLanguageContents))]
